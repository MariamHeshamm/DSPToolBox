...
namespace DSPAlgorithms.Algorithms
{
    ...
    {
        public Signal InputTimeDomainSignal { get; set; }//input signal 3ady
        public FILTER_TYPES InputFilterType { get; set; }//no3 elfilter bta3y
        public float InputFS { get; set; }//dah keda elsampling frequency
        public float? InputCutOffFrequency { get; set; }//dah cutoff freq
        public float? InputF1 { get; set; }//f1 w f2 dol llband pass wl band stop
        public float? InputF2 { get; set; }
        public float InputStopBandAttenuation { get; set; }//3shan ashof anhy window fn hst5dmha
        public float InputTransitionBand { get; set; }//deh ely hya delta F 
        public Signal OutputHn { get; set; }// w deh window yimes hD
        public Signal OutputYn { get; set; }//deh h3mlha convolution m3 elinput signal
